...
namespace Policlinica.Meniuri
{
    public partial class MeniuAsistent : Form, IDezautentificare
    {
        ...
        public MeniuAsistent(string nume, string prenume, string emailLogin, string idUtilizator)
        {
            ...
            conn = new MySqlConnection("Server=127.0.0.1;Database=policlinica;Uid=root;Pwd=xyz");
            conn.Open();
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                conn = new MySqlConnection("Server=localhost;Database=policlinica;Uid='root';Pwd='xyz';");
                conn.Open();
